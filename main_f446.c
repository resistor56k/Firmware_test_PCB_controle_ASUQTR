...
/* USER CODE BEGIN PV */
uint8_t txdata[31] = { 47, 66,135,  8,209, 14, 75, 36,
	  	  	  	  	  250, 44, 16,  8,  6, 90, 37, 81,
					  2,  0, 64,107, 58,  3,167,138,
					  114,190, 30, 49, 20, 78,  1};
uint8_t rxdata[31];
uint8_t sendbuff[31];
...
void HAL_I2C_AddrCallback(I2C_HandleTypeDef *hi2c, uint8_t TransferDirection, uint16_t AddrMatchCode)
{
    ...
    {HAL_I2C_Slave_Seq_Receive_IT(hi2c, receivbuff, 31, I2C_FIRST_AND_LAST_FRAME);}
    else if(TransferDirection == I2C_DIRECTION_RECEIVE)
    {HAL_I2C_Slave_Seq_Transmit_IT(hi2c, sendbuff, 31, I2C_FIRST_AND_LAST_FRAME);}
}
